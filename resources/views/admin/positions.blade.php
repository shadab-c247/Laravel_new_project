@extends('layouts.panel', ['title' => 'Positions Management'])
...
function openUpdatePositionModal(id, name) {
    ...
    document.getElementById('updatePositionForm').action = '/admin/positions/' + id;
...
function openDeletePositionModal(id, name) {
    ...
    document.getElementById('deletePositionForm').action = '/admin/positions/' + id;
