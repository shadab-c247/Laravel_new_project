...
<div class="panel-shell">
    ...
    <main class="panel-main">
        <header class="topbar">
            ...
            @if(auth()->user()->hasModulePermission('departments', 'create'))
                    ...
                    <table class="users-table">
                        <thead>
                            <tr>
                                ...
                                <th>Name</th>
                                <th>Created At</th>
                                @if(auth()->user()->hasModulePermission('departments', 'edit') || auth()->user()->hasModulePermission('departments', 'delete'))
...
<div id="createDepartmentModal" class="modal-backdrop" style="display: none;">
    <div class="modal-card">
        ...
        @endif
        <form method="POST" action="{{ route('user.departments.store') }}">
            @csrf
...
function openUpdateDepartmentModal(id, name) {
    ...
    document.getElementById('updateDepartmentForm').action = '/user/departments/' + id;
...
function openDeleteDepartmentModal(id, name) {
    ...
    document.getElementById('deleteDepartmentForm').action = '/user/departments/' + id;
